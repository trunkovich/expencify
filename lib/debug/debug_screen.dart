...
class _DebugScreenState extends State<DebugScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: const AppDrawer(currentRoute: AppRoutes.debug),
      body: SafeArea(
        minimum: const EdgeInsets.all(16),
        child: ListView(
          children: [
            const Text(
              'Tools for development/testing. Prefer running with internet ON to test server rules.',
